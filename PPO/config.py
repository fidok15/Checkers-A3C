...
class PPOConfig:
    ...
    opponent_pool_size: int = 50     # max past model snapshots to keep
    opponent_pool_interval: int = 3  # add current model to pool every N updates
    mcts_opponent_ratio: float = 0.20 # fraction of games vs MCTS (0.0 = pure self-play, 1.0 = pure MCTS)
    mcts_opponent_playouts: int = 200 # MCTS playouts per move during training
